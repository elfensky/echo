...
if(isset($_POST)){
	...
	$stmt1 = $db->prepare("INSERT INTO template_data 
	(info_id, template, version_name, version_number, last_modified_by, last_modified_on, data_description) 
	VALUES (:info_id, :template, :version_name, :version_number, :last_modified_by, :last_modified_on, :data_description);");

	$stmt1->bindValue(":info_id", $info_id);
	...
	$new_version_id = $db->lastInsertRowID();
	...
	//UPDATE TEMPLATES_DEPARTMENTS with NEW VALUES
	...
	//used to redirect ot the newly created branch
	echo $new_version_id;
